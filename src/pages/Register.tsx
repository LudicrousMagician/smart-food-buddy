      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="form-card">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-field pl-12 ${errors.name ? 'border-destructive ring-destructive/20' : ''}`}
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-field pl-12 pr-12 ${errors.confirmPassword ? 'border-destructive ring-destructive/20' : ''}`}
                />
                <button
                  type="button"
            ...
            >
              {isLoading ? <Loader size="sm" text="" /> : 'Create Account'}
            </button>
          </form>
